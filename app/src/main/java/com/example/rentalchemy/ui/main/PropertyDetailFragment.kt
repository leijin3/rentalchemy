    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        editSaveBut.setOnClickListener{
            if (isEditing){ //Clicked "Save"
                var newProperty : Property = Property(-1, -1, streetTV.text.toString(),
                    cityTV.text.toString(), stateTV.text.toString(), postalCodeTV.text.toString(),
                    rentAmtTV.text.toString(), propertyTypeSpinner.selectedItem.toString(),
                    parseInt(sqftTV.text.toString()), parseInt(bedsTV.text.toString()),
                    parseInt(bathsTV.text.toString()), costBasisTV.text.toString(),
                    dateAcqTV.text.toString(), yearBuiltTV.text.toString(), parseInt(parkingTV.text.toString()) )
